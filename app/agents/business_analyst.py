...
business_analysis_task = Task(
    description=(
        "Analyze the following user input and project constraints to identify the business requirements:\n\n"
        "=== USER INPUT ===\n{user_input}\n\n"
        "Identify:\n"
        "1. Problem statement\n"
        "2. Users\n"
    ...
    expected_output="A JSON object containing problem_statement, users, stakeholders, functional_requirements, non_functional_requirements, mvp_scope, future_scope, constraints, assumptions, risks, and open_questions.",
